...
$db_laundri = mysqli_query($conn, "SELECT * FROM tb_laundri");
?>
...
<body>
    ...
    <h1 class = "position-absolute top-50 start-50 translate-middle"> Daftar pesanan</h1>

    <br>
    <div>
        <a href="tambah.php" class="btn btn-outline-dark">tambah pesanan</a>
    </div>
     <br> <br>
